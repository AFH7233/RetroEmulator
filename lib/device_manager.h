...
uint8_t read_device(struct device_manager manager[static 1], uint16_t address);
void write_device(struct device_manager manager[static 1], uint16_t address, uint8_t value);
void add_device(struct device_manager manager[static 1], uint16_t start, uint16_t end, struct bus_device device[static 1]);
